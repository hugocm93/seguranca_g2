...
public class MenuWindow {
	...
	//Cabeçalho
	public JLabel _loginLabel;
	public JLabel _grupoLabel;
	public JLabel _nomeLabel;
	
	//Corpo1
	public JLabel _queriesLabel;
	public JLabel _acessesLabel;
	public JLabel _usersLabel;
	...
	private void initialize() {
		...
		_certificateArea.setColumns(30);
		scrollPane_1.setViewportView(_certificateArea);
		
		_privateKeyArea = new JTextArea();
		_privateKeyArea.setColumns(30);
		_privateKeyArea.setLineWrap(true);
		_privateKeyArea.setWrapStyleWord(true);
		scrollPane.setViewportView(_privateKeyArea);
		...
		_groupJComboBox = new JComboBox<Group>();
		_groupJComboBox.setModel(new DefaultComboBoxModel<Group>(Group.values()));
		...
		_listingsLabel = new JLabel("placeholder");
		...
		_queriesLabel = new JLabel("placeholder");
		...
		_usersLabel = new JLabel("placeholder");
		...
		_acessesLabel = new JLabel("placeholder");
		...
		_loginLabel = new JLabel("loginPlaceholder");
		
		_grupoLabel = new JLabel("grupoPlaceholder");
		
		_nomeLabel = new JLabel("nomePlaceholder");
			...
			gl__header.createParallelGroup(Alignment.LEADING)
				.addGroup(gl__header.createSequentialGroup()
					...
					.addGroup(gl__header.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(_grupoLabel)
						.addComponent(_nomeLabel))
